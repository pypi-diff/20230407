# Comparing `tmp/posym-0.5.1.tar.gz` & `tmp/posym-0.5.2.tar.gz`
...
### Comparing `posym-0.5.1/posym/__init__.py` & `posym-0.5.2/posym/__init__.py`
...
### Comparing `posym-0.5.1/setup.py` & `posym-0.5.2/setup.py`
