# Comparing `tmp/test_rest_api-0.0.0.0.22.tar.gz` & `tmp/test_rest_api-0.0.0.0.23.tar.gz`
...
### Comparing `test_rest_api-0.0.0.0.22/README.md` & `test_rest_api-0.0.0.0.23/README.md`
