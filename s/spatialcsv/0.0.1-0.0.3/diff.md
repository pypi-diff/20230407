# Comparing `tmp/spatialcsv-0.0.1.tar.gz` & `tmp/spatialcsv-0.0.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "spatialcsv-0.0.1.tar", last modified: Sun Apr  2 12:46:06 2023, max compression
+gzip compressed data, was "spatialcsv-0.0.3.tar", last modified: Fri Apr  7 18:11:48 2023, max compression
```

## Comparing `spatialcsv-0.0.1.tar` & `spatialcsv-0.0.3.tar`

### file list

```diff
@@ -1,21 +1,22 @@
-drwxr-xr-x   0 thomer    (1000) thomer    (1000)        0 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/
--rw-r--r--   0 thomer    (1000) thomer    (1000)     1560 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/LICENSE
--rw-r--r--   0 thomer    (1000) thomer    (1000)      122 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/MANIFEST.in
--rw-r--r--   0 thomer    (1000) thomer    (1000)     1415 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/PKG-INFO
--rw-r--r--   0 thomer    (1000) thomer    (1000)      603 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/README.md
--rw-r--r--   0 thomer    (1000) thomer    (1000)        0 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/requirements.txt
--rw-r--r--   0 thomer    (1000) thomer    (1000)      393 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/setup.cfg
--rw-r--r--   0 thomer    (1000) thomer    (1000)     1908 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/setup.py
-drwxr-xr-x   0 thomer    (1000) thomer    (1000)        0 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/spatialcsv/
--rw-r--r--   0 thomer    (1000) thomer    (1000)      123 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/spatialcsv/__init__.py
--rw-r--r--   0 thomer    (1000) thomer    (1000)      445 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/spatialcsv/cli.py
--rw-r--r--   0 thomer    (1000) thomer    (1000)       19 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/spatialcsv/spatialcsv.py
-drwxr-xr-x   0 thomer    (1000) thomer    (1000)        0 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/spatialcsv.egg-info/
--rw-r--r--   0 thomer    (1000) thomer    (1000)     1415 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/PKG-INFO
--rw-r--r--   0 thomer    (1000) thomer    (1000)      362 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/SOURCES.txt
--rw-r--r--   0 thomer    (1000) thomer    (1000)        1 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/dependency_links.txt
--rw-r--r--   0 thomer    (1000) thomer    (1000)       51 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/entry_points.txt
--rw-r--r--   0 thomer    (1000) thomer    (1000)        1 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/not-zip-safe
--rw-r--r--   0 thomer    (1000) thomer    (1000)       11 2023-04-02 12:46:06.000000 spatialcsv-0.0.1/spatialcsv.egg-info/top_level.txt
-drwxr-xr-x   0 thomer    (1000) thomer    (1000)        0 2023-04-02 12:46:06.117418 spatialcsv-0.0.1/tests/
--rw-r--r--   0 thomer    (1000) thomer    (1000)      402 2023-04-02 12:42:12.000000 spatialcsv-0.0.1/tests/test_spatialcsv.py
...
### Comparing `spatialcsv-0.0.1/LICENSE` & `spatialcsv-0.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `spatialcsv-0.0.1/PKG-INFO` & `spatialcsv-0.0.3/PKG-INFO`
...
### Comparing `spatialcsv-0.0.1/README.md` & `spatialcsv-0.0.3/README.md`
...
### Comparing `spatialcsv-0.0.1/setup.py` & `spatialcsv-0.0.3/setup.py`
...
### Comparing `spatialcsv-0.0.1/spatialcsv.egg-info/PKG-INFO` & `spatialcsv-0.0.3/spatialcsv.egg-info/PKG-INFO`
