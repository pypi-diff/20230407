# Comparing `tmp/ConGen-0.0.3.tar.gz` & `tmp/ConGen-0.0.4.tar.gz`
...
### Comparing `ConGen-0.0.3/LICENSE` & `ConGen-0.0.4/LICENSE`
...
### Comparing `ConGen-0.0.3/src/ConGen.egg-info/SOURCES.txt` & `ConGen-0.0.4/src/ConGen.egg-info/SOURCES.txt`
...
### Comparing `ConGen-0.0.3/src/python-congen-git/build/lib/congen/exporters/CustomJSONDecoder.py` & `ConGen-0.0.4/src/python-congen-git/build/lib/congen/exporters/CustomJSONDecoder.py`
...
### Comparing `ConGen-0.0.3/src/python-congen-git/gb_output.py` & `ConGen-0.0.4/src/python-congen-git/gb_output.py`
...
### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/DependentLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/DependentLayer.py`
...
### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/pointLayers/clustered/WardClusteredPointLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/pointLayers/clustered/WardClusteredPointLayer.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/rasterLayers/ImportedRasterLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/rasterLayers/ImportedRasterLayer.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/rasterLayers/NoiseRasterLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/rasterLayers/NoiseRasterLayer.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/rasterLayers/PointRasterLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/rasterLayers/PointRasterLayer.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/layers/rasterLayers/RasterLayer.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/layers/rasterLayers/RasterLayer.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/ui/LayerListCtrl.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/ui/LayerListCtrl.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/ui/MainCanvasPanel.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/ui/MainCanvasPanel.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/ui/MainFrame.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/ui/MainFrame.py`

 * *Files identical despite different names*

### Comparing `ConGen-0.0.3/src/python-congen-git/src/congen/ui/ValueChoice.py` & `ConGen-0.0.4/src/python-congen-git/src/congen/ui/ValueChoice.py`
