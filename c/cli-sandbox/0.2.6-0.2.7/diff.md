# Comparing `tmp/cli-sandbox-0.2.6.tar.gz` & `tmp/cli-sandbox-0.2.7.tar.gz`
...
## Comparing `cli-sandbox-0.2.6.tar` & `cli-sandbox-0.2.7.tar`
...
### Comparing `cli-sandbox-0.2.6/PKG-INFO` & `cli-sandbox-0.2.7/PKG-INFO`
...
### Comparing `cli-sandbox-0.2.6/cli_sandbox.egg-info/PKG-INFO` & `cli-sandbox-0.2.7/cli_sandbox.egg-info/PKG-INFO`
...
### Comparing `cli-sandbox-0.2.6/setup.py` & `cli-sandbox-0.2.7/setup.py`
