# Comparing `tmp/Winfo-0.0.1.3.tar.gz` & `tmp/Winfo-0.0.1.4.tar.gz`
...
### Comparing `Winfo-0.0.1.3/LICENSE` & `Winfo-0.0.1.4/LICENSE`
...
### Comparing `Winfo-0.0.1.3/Winfo/__init__.py` & `Winfo-0.0.1.4/Winfo/__init__.py`
