# Comparing `tmp/morphqs-0.1.2.tar.gz` & `tmp/morphqs-0.1.20.tar.gz`
...
## Comparing `morphqs-0.1.2.tar` & `morphqs-0.1.20.tar`
...
### Comparing `morphqs-0.1.2/LICENSE.txt` & `morphqs-0.1.20/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `morphqs-0.1.2/PKG-INFO` & `morphqs-0.1.20/PKG-INFO`
...
### Comparing `morphqs-0.1.2/morphqs/components/uchigheredmsp.py` & `morphqs-0.1.20/morphqs/components/uchigheredmsp.py`
...
### Comparing `morphqs-0.1.2/morphqs/logging/loghandler.py` & `morphqs-0.1.20/morphqs/logging/loghandler.py`

 * *Files identical despite different names*

### Comparing `morphqs-0.1.2/morphqs/morphclass.py` & `morphqs-0.1.20/morphqs/morphclass.py`

 * *Files identical despite different names*

### Comparing `morphqs-0.1.2/morphqs.egg-info/PKG-INFO` & `morphqs-0.1.20/morphqs.egg-info/PKG-INFO`
...
### Comparing `morphqs-0.1.2/setup.py` & `morphqs-0.1.20/setup.py`
