# Comparing `tmp/basecfg-1.0.1.tar.gz` & `tmp/basecfg-1.1.0.tar.gz`
...
## Comparing `basecfg-1.0.1.tar` & `basecfg-1.1.0.tar`
...
### Comparing `basecfg-1.0.1/LICENSE` & `basecfg-1.1.0/LICENSE`

 * *Files identical despite different names*

### Comparing `basecfg-1.0.1/PKG-INFO` & `basecfg-1.1.0/PKG-INFO`
...
### Comparing `basecfg-1.0.1/pyproject.toml` & `basecfg-1.1.0/pyproject.toml`
...
### Comparing `basecfg-1.0.1/src/basecfg/basecfg.py` & `basecfg-1.1.0/src/basecfg/basecfg.py`
...
### Comparing `basecfg-1.0.1/src/basecfg.egg-info/PKG-INFO` & `basecfg-1.1.0/src/basecfg.egg-info/PKG-INFO`
