# Comparing `tmp/heartfelt_tools-0.8.0.tar.gz` & `tmp/heartfelt_tools-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "heartfelt_tools-0.8.0.tar", max compression
+gzip compressed data, was "heartfelt_tools-1.0.5.tar", max compression
```

## Comparing `heartfelt_tools-0.8.0.tar` & `heartfelt_tools-1.0.5.tar`

### file list

```diff
@@ -1,25 +1,19 @@
--rw-r--r--   0        0        0     1065 2022-10-21 01:09:12.000000 heartfelt_tools-0.8.0/LICENSE
--rw-r--r--   0        0        0     7303 2023-02-09 01:30:00.000000 heartfelt_tools-0.8.0/README.md
--rw-r--r--   0        0        0        0 2023-02-12 21:09:30.000000 heartfelt_tools-0.8.0/database_tools/__init__.py
--rw-r--r--   0        0        0        0 2023-04-05 20:53:23.596958 heartfelt_tools-0.8.0/database_tools/datastores/__init__.py
--rw-r--r--   0        0        0      938 2023-04-07 19:00:09.619442 heartfelt_tools-0.8.0/database_tools/datastores/records.py
--rw-r--r--   0        0        0     2520 2023-04-07 18:53:23.861591 heartfelt_tools-0.8.0/database_tools/datastores/signals.py
--rw-r--r--   0        0        0        0 2023-04-05 20:53:23.596958 heartfelt_tools-0.8.0/database_tools/errors.py
--rw-r--r--   0        0        0        0 2023-04-05 20:53:23.596958 heartfelt_tools-0.8.0/database_tools/io/__init__.py
--rw-r--r--   0        0        0      470 2023-04-07 17:47:29.796060 heartfelt_tools-0.8.0/database_tools/io/data.py
--rw-r--r--   0        0        0      224 2023-04-07 17:58:25.968297 heartfelt_tools-0.8.0/database_tools/io/utils.py
--rw-r--r--   0        0        0     7001 2023-04-07 20:08:43.428482 heartfelt_tools-0.8.0/database_tools/io/wfdb.py
--rw-r--r--   0        0        0        0 2023-02-09 01:25:56.000000 heartfelt_tools-0.8.0/database_tools/processing/__init__.py
--rw-r--r--   0        0        0     1228 2023-04-05 20:48:44.315318 heartfelt_tools-0.8.0/database_tools/processing/cardiac.py
--rw-r--r--   0        0        0     2721 2023-04-07 19:06:50.432508 heartfelt_tools-0.8.0/database_tools/processing/detect.py
--rw-r--r--   0        0        0     4765 2023-04-07 19:04:56.823116 heartfelt_tools-0.8.0/database_tools/processing/metrics.py
--rw-r--r--   0        0        0     1859 2023-04-07 20:26:24.799112 heartfelt_tools-0.8.0/database_tools/processing/modify.py
--rw-r--r--   0        0        0     5038 2023-04-07 20:26:09.535953 heartfelt_tools-0.8.0/database_tools/processing/utils.py
--rw-r--r--   0        0        0    10403 2023-04-05 21:19:59.194064 heartfelt_tools-0.8.0/database_tools/tools/DataEvaluator.py
--rw-r--r--   0        0        0     3080 2023-02-09 01:25:56.000000 heartfelt_tools-0.8.0/database_tools/tools/DataLocator.py
--rw-r--r--   0        0        0       82 2023-04-07 20:11:00.337873 heartfelt_tools-0.8.0/database_tools/tools/__init__.py
--rw-r--r--   0        0        0    12219 2023-04-07 21:30:33.134370 heartfelt_tools-0.8.0/database_tools/tools/dataset.py
--rw-r--r--   0        0        0     6884 2023-04-07 20:11:10.345976 heartfelt_tools-0.8.0/database_tools/tools/records.py
--rw-r--r--   0        0        0      953 2023-04-07 21:34:17.522600 heartfelt_tools-0.8.0/pyproject.toml
--rw-r--r--   0        0        0     8623 1970-01-01 00:00:00.000000 heartfelt_tools-0.8.0/setup.py
--rw-r--r--   0        0        0     8342 1970-01-01 00:00:00.000000 heartfelt_tools-0.8.0/PKG-INFO
...
### Comparing `heartfelt_tools-0.8.0/LICENSE` & `heartfelt_tools-1.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `heartfelt_tools-0.8.0/README.md` & `heartfelt_tools-1.0.5/README.md`

 * *Files identical despite different names*

### Comparing `heartfelt_tools-0.8.0/database_tools/processing/cardiac.py` & `heartfelt_tools-1.0.5/database_tools/preprocessing/cardiac.py`

 * *Files identical despite different names*

### Comparing `heartfelt_tools-0.8.0/database_tools/processing/metrics.py` & `heartfelt_tools-1.0.5/database_tools/preprocessing/functions.py`
...
### Comparing `heartfelt_tools-0.8.0/database_tools/tools/DataLocator.py` & `heartfelt_tools-1.0.5/database_tools/tools/DataLocator.py`

 * *Files identical despite different names*

### Comparing `heartfelt_tools-0.8.0/database_tools/tools/records.py` & `heartfelt_tools-1.0.5/database_tools/tools/records.py`
...
### Comparing `heartfelt_tools-0.8.0/pyproject.toml` & `heartfelt_tools-1.0.5/pyproject.toml`
...
### Comparing `heartfelt_tools-0.8.0/setup.py` & `heartfelt_tools-1.0.5/setup.py`
...
-'heartfelt-tools', 'version': '0.8.0', 'description': 'Extract and process
...
### Comparing `heartfelt_tools-0.8.0/PKG-INFO` & `heartfelt_tools-1.0.5/PKG-INFO`
...
```diff
@@ -1,21 +1,20 @@
-Metadata-Version: 2.1 Name: heartfelt-tools Version: 0.8.0 Summary: Extract and
